...
/*   Updated: 2025/01/20 18:21:26 by rlebaill         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_pipe(char ***splited_split, char *input, t_mini *mini)
{
	...
	if (have_double_left(splited_split[0]))
		return (ft_heredoc(splited_split[0]));
	else
		return (ft_command(splited_split[0], splited_split, input, mini));
}
